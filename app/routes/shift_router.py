...
from app.schemas.shift import ShiftCreate, ShiftSchema, EmployeeShiftAssignmentCreate, EmployeeShiftAssignmentSchema
...
def get_current_shift(employee_id: str, target_date: date = date.today(), db: Session = Depends(get_db)):
