...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column(
        "leave_types", sa.Column("duration_days", sa.Integer(), nullable=False, server_default="0")
    )
    op.add_column(
        "leave_types", sa.Column("monthly_limit", sa.Integer(), nullable=False, server_default="0")
    )
    op.add_column(
        "leave_types", sa.Column("yearly_limit", sa.Integer(), nullable=False, server_default="0")
    )
    op.add_column(
        "leave_types",
        sa.Column(
            "carry_forward_allowed", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
    )
