...
Revision ID: 7d9c5ce98231
Revises: aaf1b0408214
Create Date: 2025-11-19 17:07:36.219593
...
revision: str = "7d9c5ce98231"
down_revision: Union[str, Sequence[str], None] = "aaf1b0408214"
...
def upgrade() -> None:
    """Upgrade schema."""
    # This revision was generated backwards and contained destructive drop
    # operations in the forward migration. Keep it as a no-op so fresh
    # Supabase migrations preserve the schema created by earlier revisions.
    pass
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("attendance_days_employee_id_fkey"),
            ondelete="CASCADE",
        ),
        ...
        sa.UniqueConstraint(
            "employee_id",
            "work_date_local",
            name=op.f("uq_attendance_day_emp_date"),
            postgresql_include=[],
    ...
    op.create_index(
        op.f("ix_attendance_day_emp_month"),
        "attendance_days",
    ...
    op.create_index(
        op.f("ix_holiday_region_date"), "holiday_calendar", ["region", "holiday_date"], unique=False
    )
    op.create_index(
        op.f("ix_holiday_calendar_region"), "holiday_calendar", ["region"], unique=False
    )
    op.create_index(
        op.f("ix_holiday_calendar_holiday_date"), "holiday_calendar", ["holiday_date"], unique=False
    )
    op.create_table(
        "attendance_sessions",
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('attendance_sessions_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column("employee_id", sa.VARCHAR(length=50), autoincrement=False, nullable=False),
        sa.Column(
            "check_in_utc", postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False
        ),
        sa.Column(
            "check_out_utc", postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True
        ),
        sa.Column("work_date_local", sa.DATE(), autoincrement=False, nullable=False),
        sa.Column(
            "created_at",
        ...
        sa.CheckConstraint(
            "check_out_utc IS NULL OR check_out_utc >= check_in_utc", name="ck_session_chronology"
        ),
        sa.ForeignKeyConstraint(
            ["employee_id"],
            ["employees.employee_id"],
    ...
    op.create_index(
        op.f("ix_session_emp_open"),
        "attendance_sessions",
        ["employee_id", "check_out_utc"],
        unique=False,
    )
    op.create_index(
        op.f("ix_session_emp_date"),
        "attendance_sessions",
        ["employee_id", "work_date_local"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('leave_types_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        ...
        sa.Column(
            "unit",
            postgresql.ENUM("DAY", "HOUR", name="leave_unit_enum"),
            autoincrement=False,
            nullable=False,
        ),
        sa.Column("is_paid", sa.BOOLEAN(), autoincrement=False, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "adjusted", sa.NUMERIC(precision=6, scale=2), autoincrement=False, nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["employee_id"],
            ["employees.employee_id"],
            name=op.f("leave_balances_employee_id_fkey"),
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["leave_type_id"],
            ["leave_types.id"],
            name=op.f("leave_balances_leave_type_id_fkey"),
            ondelete="RESTRICT",
        ),
        ...
        sa.UniqueConstraint(
            ...
            "year",
            "month",
            name=op.f("uq_leave_balance_emp_type_year_month"),
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    )
    ...
    op.create_index(
        op.f("ix_leave_balance_emp_year_month"),
        "leave_balances",
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_shift_assign_range"),
        ),
        sa.ForeignKeyConstraint(
            ["employee_id"],
            ["employees.employee_id"],
            name=op.f("employee_shift_assignments_employee_id_fkey"),
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["shift_id"],
            ["shifts.id"],
            name=op.f("employee_shift_assignments_shift_id_fkey"),
            ondelete="RESTRICT",
        ),
        ...
        sa.UniqueConstraint(
            ...
            "shift_id",
            "effective_from",
            name=op.f("uq_shift_assign_start"),
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    )
    op.create_index(
        op.f("ix_shift_assign_emp_from"),
        "employee_shift_assignments",
    ...
    op.create_index(
        op.f("ix_workweek_policies_region"), "workweek_policies", ["region"], unique=True
    )
    op.create_table(
        "checkin_monitoring",
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        ...
        sa.Column(
            "cpu_percent", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        sa.Column(
            "memory_percent", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
        sa.Column(
            "active_apps",
            postgresql.JSONB(astext_type=sa.Text()),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "total_hours >= 1 AND total_hours <= 24", name=op.f("ck_shift_total_hours")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "marital_status",
            postgresql.ENUM("SINGLE", "MARRIED", name="maritalstatus"),
            autoincrement=False,
            nullable=False,
        ),
        ...
        sa.Column(
            "department",
            postgresql.ENUM("HR", "IT", "SALES", "FINANCE", "MARKETING", name="department"),
            autoincrement=False,
            nullable=False,
        ),
        ...
        sa.UniqueConstraint(
            "aadhar_number",
            name="uq_employee_aadhar_number",
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
        sa.UniqueConstraint(
        ...
        sa.UniqueConstraint(
            "employee_id",
            name="uq_employee_employee_id",
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
        sa.UniqueConstraint(
            "mobile_number",
            name="uq_employee_mobile_number",
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
        sa.UniqueConstraint(
            "pan_number",
            name="uq_employee_pan_number",
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
        postgresql_ignore_search_path=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "end_datetime", postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False
        ),
        sa.Column(
            "requested_unit",
            postgresql.ENUM("DAY", "HALF_DAY", "HOUR", name="leave_req_unit_enum"),
            autoincrement=False,
            nullable=False,
        ),
        sa.Column(
            "requested_hours", sa.NUMERIC(precision=5, scale=2), autoincrement=False, nullable=True
        ),
        sa.Column(
            "status",
            postgresql.ENUM(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["employees.employee_id"],
            name=op.f("leave_requests_approver_employee_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["employee_id"],
            ["employees.employee_id"],
            name=op.f("leave_requests_employee_id_fkey"),
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["leave_type_id"],
            ["leave_types.id"],
            name=op.f("leave_requests_leave_type_id_fkey"),
            ondelete="RESTRICT",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("leave_requests_pkey")),
    )
    op.create_index(
        op.f("ix_leave_requests_start_datetime"), "leave_requests", ["start_datetime"], unique=False
    )
    op.create_index(
        op.f("ix_leave_requests_end_datetime"), "leave_requests", ["end_datetime"], unique=False
    )
    op.create_index(
