...
def downgrade() -> None:
    ...
    sa.Column('category', postgresql.ENUM('Food', 'Transport', 'Utilities', 'Entertainment', 'Progress', 'Office', 'Travel', 'Software', 'Health', 'Other', 'Shopping', name='expense_category'), autoincrement=False, nullable=False),
