...
def upgrade():
    op.add_column('employee_bank_details', sa.Column('uan_number', sa.String(length=50), nullable=True))
    op.add_column('employee_bank_details', sa.Column('pf_number', sa.String(length=50), nullable=True))
